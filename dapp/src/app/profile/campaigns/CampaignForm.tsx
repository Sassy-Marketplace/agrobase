...
import { BriefcaseIcon, CalendarIcon, CoinsIcon, LockIcon, MapPinIcon, PencilIcon, TargetIcon, UserIcon, WalletIcon } from "lucide-react";
...
const CampaignForm : React.FC = () => {
      ...
      useEffect(()=>{
        if(name.length && duration > 0 && goal > 0 && totalNfts > 0 && tokenAddress.length && nftAddress){
            setIsPending(false);
        }
